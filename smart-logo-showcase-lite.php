 ...
 * */
defined( 'SMLS_VERSION' ) or define( 'SMLS_VERSION', '1.1.7' ); //plugin version
...
if ( ! class_exists( 'SMLS_Class' ) ) {
    ...
    class SMLS_Class{
        ...
        function __construct(){
            ...
            include('inc/smls-block/smls-block-init.php');
        ...
        function smls_register_assets(){
            ...
            wp_enqueue_style( 'smls-popup-style', SMLS_CSS_DIR . '/popup-contact.css', false, SMLS_VERSION );            
        ...
        function smls_premium_wp(){
            wp_redirect( 'https://accesspressthemes.com/wordpress-plugins/smart-logo-showcase/', 301 );
            exit;
        }
        ...
        function smls_admin_footer_text( $text ){
            ...
            if ( 'smartlogo' == $post -> post_type ) {
                ...
                $pro_link = 'https://accesspressthemes.com/wordpress-plugins/smart-logo-showcase/';
        ...
        function smls_plugin_row_meta( $links, $file ){
            if ( strpos( $file, 'smart-logo-showcase-lite.php' ) !== false ) {
                $new_links = array(
                    ...
                    'pro' => '<a href="https://accesspressthemes.com/wordpress-plugins/smart-logo-showcase/" target="_blank"><span class="dashicons dashicons-cart"></span>Premium version</a>'
                );
