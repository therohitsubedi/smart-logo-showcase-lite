...
<div class="smls-general-setting-wrapper">
    ...
    <div class="smls-setting-wrapper">
        <label><?php _e( 'Contact Details', SMLS_TD ); ?></label>
        <div class="smls-setting-field">
            <select name="smls_settings[contact_details_enabled]" class="smls-full-view-type">
                <option  value="enable" <?php if ( ! empty( $smls_settings[ 'contact_details_enabled' ] ) ) selected( $smls_settings[ 'contact_details_enabled' ], 'enable' ); ?>><?php _e( 'Enable', SMLS_TD ) ?></option>
                <option class="smls-inline-on" value="disable" <?php if ( ! empty( $smls_settings[ 'contact_details_enabled' ] ) ) selected( $smls_settings[ 'contact_details_enabled' ], 'disable' ); ?>><?php _e( 'Disable ', SMLS_TD ) ?></option>
            </select>
            <div class="smls-note-wrap">
                <p class="description">
                    <?php _e( 'Please enable this to show the contact details popup for Grid Layout only', SMLS_TD ); ?>
                </p>
            </div>
        </div>
